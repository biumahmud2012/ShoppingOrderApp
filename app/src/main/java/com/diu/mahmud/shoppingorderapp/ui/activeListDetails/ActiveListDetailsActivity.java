...
public class ActiveListDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
         ...
         */
        mCurrentUserRef = FirebaseDatabase.getInstance().getReferenceFromUrl(Constants.FIREBASE_URL_ACTIVE_LISTS).child(mEncodedEmail).child(mListId);
        ...
        DatabaseReference listItemsRef = FirebaseDatabase.getInstance().getReferenceFromUrl
                        (Constants.FIREBASE_URL_SHOPPING_LIST_ITEMS).child(mListId);
 ...
 /* Perform buy/return action on listView item click event if current user is shopping. */
                ...
                if (view.getId() != R.id.list_view_footer_empty) {
                    ...
                    if (selectedListItem != null) {
                        ...
                        if (mShopping) {
                            ...
                            DatabaseReference firebaseItemLocation = FirebaseDatabase.getInstance().getReferenceFromUrl(Constants.FIREBASE_URL_SHOPPING_LIST_ITEMS)
    ...
    public void toggleShopping(View view) {
         ...
         */
        DatabaseReference usersShoppingRef = FirebaseDatabase.getInstance().getReferenceFromUrl(Constants.FIREBASE_URL_ACTIVE_LISTS)
